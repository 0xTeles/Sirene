...
const getAlert = () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  {
    repository(owner:"${env_1.Env.github_repository_owner}" name:"${env_1.Env.github_repository_name}") {
  ...
  `, {
    ...
    return (JSON.stringify((_a = repository.vulnerabilityAlerts) === null || _a === void 0 ? void 0 : _a.edges));
});
